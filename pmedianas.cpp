...
int main(int argc, char** argv) {
	...
	try {
		...
		//Declarando a matriz de alocação, onde Xij = 1 se j é alocado à mediana i
		//Xij é uma matriz binária NxN
		...
		/*Restrição 1
		com i variando até N, o somatório de Xii deve ser 
		igual ao número de medianas
		*/
		IloExpr r1(env);
		for (int i = 0;i < N;i++) {
			r1 += x[i][i];
